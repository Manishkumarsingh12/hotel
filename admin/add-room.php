	...
	<body>
		<div class="page-container">
										...
										<div class="form-grids widget-shadow" data-example-id="basic-forms">
											...
											<div class="form-body">
												...
												<form method="post" enctype="multipart/form-data">
													...
													<div class="form-group"> <label for="exampleInputEmail1">Max Adult</label> <input type="number" class="form-control" name="maxadult" value="" required='true'> </div>
													<div class="form-group"> <label for="exampleInputEmail1">Max Child</label> <input type="number" class="form-control" name="maxchild" value="" required='true'> </div>
													<div class="form-group"> <label for="exampleInputEmail1">Room Number</label> <input type="text" class="form-control" name="room_no"  required>
													<small class="form-text" style="color:red;" id="room_no_alert"></small>			
												    </div>
													...
													<div class="form-group"> <label for="exampleInputEmail1">No. of Bed</label> <input type="number" class="form-control" name="nobed" value="" required='true'> </div>
													<div class="form-group">
														<label for="exampleInputEmail1">Room Image</label>
														<input type="file" class="form-control" name="image" value="" required='true'>
													</div>
													<div class="form-group"> <label for="exampleInputEmail1">Room Facility</label> <select type="text" id="multiple-checkboxes" name="roomfac[]" id="roomfac" value="" class="form-control" required="true" multiple="multiple">
													...
													<button type="submit" class="btn btn-success col-3" name="submit">Add</button>
												</form>
											</div>
										</div>
									</div>
			...
			<script>
				...
				"use strict";
				var flag=false;												
				$("input[name=room_no]").on('keyup',function(){
					var res=$(this).val();
					console.log(res);
					if(res!=''){
						data_string='room_no=' + res+'&CheckRoomBookNo='+1;
						$.ajax({
								...
								success: function(responce) {
									...
									if(result=='1'){
										flag=false;	
										$('#room_no_alert').html('*This Room No is already Exists');
										$("input[name=room_no]").focus();
