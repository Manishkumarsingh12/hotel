...
$sql="SELECT * from tblcontact where MobileNumber like '$sdata%' ";
...
{               ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                         ...
                                         <td><a href="view-enquiry.php?viewid=<?php echo htmlentities ($row->ID);?> " target="_blank">View Details</a></td>
