...
<script>
	$(document).ready(function(){
		...
		var dataTable = $("#table-grid").DataTable({
                    ...
                    "scrollX": true,
					"ajax":{
						'url' :"manage_facility_table_data.php", // json datasource
...
<script>
// $('.facility_del').click(function(){
$(document).on('click', '#table-grid tbody > tr td .facility_del', function(e) {
var id=$(this).data('id');
var data_string='id='+id+'&manage_facility_delete='+1;
if(confirm('Are you sure want to Delete ? ')){
	$.ajax({
			'url' :"includes/AdminController.php", // json datasource
			'type': "post",  // method  , by default get
			'data': data_string,
