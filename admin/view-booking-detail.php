...
<div class="women_main">
	...
	<div class="grids">
				...
				//   ,tblroom.RoomName,tblroom.MaxAdult,tblroom.MaxChild,tblroom.RoomDesc,tblroom.NoofBed,tblroom.Image,tblroom.RoomFacility
				// ,tblcategory.CategoryName,tblcategory.Description,tblcategory.Price

$sql="SELECT tblbooking.RoomId,tblbooking.BookingNumber,tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tblbooking.IDType,tblbooking.Gender,tblbooking.Address,tblbooking.CheckinDate,tblbooking.CheckoutDate,tblbooking.BookingDate,tblbooking.Remark,tblbooking.Status,tblbooking.UpdationDate
...
<!-- ------------------------------------------------------------------- -->
<?php 
$roodids=explode(',' ,$row->RoomId );

foreach($roodids as $roomid){
	
 $sql1="SELECT tblroom.RoomName,tblroom.MaxAdult,tblroom.MaxChild,tblroom.RoomDesc,tblroom.NoofBed,tblroom.Image,tblroom.RoomFacility ,tblcategory.CategoryName,tblcategory.Description,tblcategory.Price
