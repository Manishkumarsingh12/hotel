                        ...
                        <div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
                                    <ul id="menu" >
                                      ...
                                      <li id="menu-academico" ><a href="#"><i class="lnr lnr-pencil"></i> <span>Packages</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >
                                            <li id="menu-academico-avaliacoes" ><a href="add-package.php">Add Packages</a></li>
                                            <li id="menu-academico-boletim" ><a href="manage-package.php">Manage package</a></li>
                                     ...
                                     <li id="menu-academico" ><a href="#"><i class="lnr lnr-book"></i> <span>Booking</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >                                           										   <li id="menu-academico-boletim" ><a href="add-new-booking.php">Add New Booking</a></li>
                                    ...
                                    <li id="menu-academico" ><a href="#"><i class="lnr lnr-layers"></i> <span>Reports</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >
                                         <li id="menu-academico-avaliacoes" ><a href="sales-reports.php">Sales Report</a></li>
                                            <li id="menu-academico-boletim" ><a href="enquiry-betdates-reports.php">Enquiry B/W Reports</a></li>
