...
$sql="SELECT * from tblcontact where IsRead='1' order by EnquiryDate desc ";//LIMIT $offset, $no_of_records_per_page
...
<script>
	$(document).ready(function(){
		...
		var dataTable = $("#table-grid").DataTable({
                    ...
                    "scrollX": true,
					"ajax":{
						'url' :"read_enquiry_table_data.php", // json datasource
